...
from leader_follower.Strategy import Strategy
from leader_follower.game_generation import generate_cells, generate_adjacence, \
    generate_p_strategy
...
def optimize3by2():
    ...
    env = generate_cells(idx_array, p_payoff_array, i_payoff_array, d_array)
    adjacence_array = generate_adjacence([(0, 1), (1, 2), (2, 5), (0, 3), (3, 4), (4, 5)],
                                         env_count)
    patroller_strat = generate_p_strategy(adjacence_array)
...
def optimize4by3():
    ...
    env = generate_cells(idx_array, p_payoff_array, i_payoff_array, d_array)
    adjacence_array = generate_adjacence([(0, 1), (1, 2), (2, 3), (2, 6), (0, 4), (4, 8), (8, 9), (9, 10), (10, 11), (10, 6)],
                                         env_count)
    patroller_strat = generate_p_strategy(adjacence_array)
